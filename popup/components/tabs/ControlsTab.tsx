...
export const ControlsTab: React.FC<ControlsTabProps> = ({
  ...
  const sliderHints: Partial<Record<keyof GradientSettings, string>> = {
    speed:
      "Controls how fast the gradient animation moves. Higher values create faster, more dynamic motion.",
    scale:
      "Adjusts the size/zoom level of the gradient pattern. Lower values zoom in, higher values zoom out.",
    distortion:
      "Amount of warping and deformation applied to the gradient. Creates fluid, organic shapes.",
    swirl:
      "Adds rotational twisting to the gradient pattern. Higher values create more spiral effects.",
    opacity:
      "Transparency level of the gradient overlay. Lower values make it more see-through.",
